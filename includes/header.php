...
<head>
	...
	<title>Sistema Gestión de Stocks</title>
...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right"> 
        ...
        <li id="navConfiguroWeb"><a href="https://www.configuroweb.com/desarrollo/"><i class="glyphicon glyphicon-globe
        "></i> ConfiguroWeb</a></li>
        ...
        <li class="dropdown" id="navOrder">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-shopping-cart"></i> Órdenes <span class="caret"></span></a>
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Agregar Órdenes</a></li>            
            <li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Gestionar Órdenes</a></li>            
          </ul>
        </li> 
