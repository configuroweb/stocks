    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					    ...
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="productImage" placeholder="Nombre Producto" name="productImage" class="file-loading" style="width:auto;"/>
					    </div>
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Nombre Producto" name="productName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
	        ...
	        <div class="form-group">
	        	<label for="categoryName" class="col-sm-3 control-label">Nombre Categoría: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="categoryName" placeholder="Nombre Producto" name="categoryName" >
				      	<option value="">~~Seleccionar~~</option>
				      	<?php 
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    ...
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Información de Producto</a></li>    
				  </ul>
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="photo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductImage" class="col-sm-3 control-label">Imagen de Producto: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">							    				   
			      	...
			      	<div class="form-group">
			        	<label for="editProductImage" class="col-sm-3 control-label">Seleccionar Fotografía: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
							    <!-- the avatar markup -->
									<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
							    <div class="kv-avatar center-block">					        
							        <input type="file" class="form-control" id="editProductImage" placeholder="Nombre de Producto" name="editProductImage" class="file-loading" style="width:auto;"/>
							    </div>
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProductName" placeholder="Nombre Producto" name="editProductName" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	    
			        ...
			        <div class="form-group">
			        	<label for="editCategoryName" class="col-sm-3 control-label">Nombre de Categoría: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>¿Realmente quieres eliminar el producto?</p>
      </div>
