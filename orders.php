...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Gestionar Orden
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Número Contacto" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Sub Monto</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">Impuesto 13%</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Cantidad</label>
				    <div class="col-sm-9">
			...
			<table class="table" id="manageOrderTable">
				<thead>
					<tr>
						...
						<th>Contacto</th>
						<th>Artículo de pedido total</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    <label for="due" class="col-sm-3 control-label">Debido Monto</label>
			    <div class="col-sm-9">
			      <input type="text" class="form-control" id="due" name="due" disabled="true" />					
			    </div>
			  </div> <!--/form-group-->		
			  <div class="form-group">
			    <label for="payAmount" class="col-sm-3 control-label">Monto Pagado</label>
			    <div class="col-sm-9">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>¿Realmente quieres eliminar orden?</p>
      </div>
